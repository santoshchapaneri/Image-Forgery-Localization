...
DCPPath='C:\Users\Sony\Desktop\project\project_3\Images8\ForgedTrainingImages\';
...
%             MaskIm(loc_i:loc_i+W-1,loc_j:loc_j+W-1) = 255;
            ...
            bk_im=bk_im(i_min:i_max, j_min:j_max, :);
...
%save('PathLocation_new.mat', 'i_min','i_max','j_min','j_max')
